...
const API_ENDPOINTS = {
  auth: {
    ...
    otpVerify: `${API_BASE_URL}/app/auth/otpverify`,
    ...
    updateEmail: `${API_BASE_URL}/app/auth/updateemailV2`,
    updatePhone: `${API_BASE_URL}/app/auth/updateNumberV2`,
    contactChangeOtpVerify: `${API_BASE_URL}/app/auth/verifycontactchangeotpV2`,
  },
  userProfile: {
    ...
    acceptFriend: `${API_BASE_URL}/app/acceptrequestV2`,
    ...
    accountOverview: `${API_BASE_URL}/app/accountoverviewV2`,
  ...
  chat: {
    ...
    searchMessage: `${API_BASE_URL}/app/messagesearchV2`,
    createGroup: `${API_BASE_URL}/app/creategroupchat`,
  },
  ...
  post: {
    ...
    hashtag: `${API_BASE_URL}/app/discoverhashtagpostlistoptV2`,
    comments: {
      ...
      likeList: `${API_BASE_URL}/app/usercommentlikelistV2`,
    },
    polls: {
  ...
  flix: {
    ...
    comments: {
      list: `${API_BASE_URL}/app/flixcommentlistV2`,
    ...
    playlists: {
      ...
      create: `${API_BASE_URL}/app/createplaylistwithepisodesV2`,
    },
    miniWatchHistory: {
      insertWatchHistory: `${API_BASE_URL}/app/flix/saveV2`,
      getWatchHistory: (userId: string) => userId ? `${API_BASE_URL}/app/flix/profilelistV2?profileUserId=${userId}` : `${API_BASE_URL}/app/flix/profilelistV2`,
  ...
  stories: {
    ...
    removeViewRestriction: `${API_BASE_URL}/app/removestoryviewrestrictionV2`,
    ...
    updateSsupSettings: `${API_BASE_URL}/app/updatessupsettingsV2`,
    storyFanListForUser: `${API_BASE_URL}/app/storyfanlistforuserV2`,
  },
  ...
  shared: {
    ...
    hashtagList: `${API_BASE_URL}/app/hashtaglistV2`,
  },
  ...
  settings: {
    ...
    deleteAccount: `${API_BASE_URL}/app/inactiveaccountV2`,
  },
